  ...
  return (
    <div ref={cardRef} className="opacity-0">
      <Link href={`/blog/${post.slug}`} className="group block">
        <article className="relative overflow-hidden rounded-2xl border border-text-primary/5 bg-bg-secondary/50 p-8 transition-colors duration-300 hover:border-accent/20 sm:p-10">
